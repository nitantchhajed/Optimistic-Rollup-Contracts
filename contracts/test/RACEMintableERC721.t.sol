...
import {
    RACEMintableERC721,
    IRACEMintableERC721
} from "../universal/RACEMintableERC721.sol";

contract RACEMintableERC721_Test is ERC721Bridge_Initializer {
    ERC721 internal L1Token;
    RACEMintableERC721 internal L2Token;
    ...
    function setUp() public override {
        ...
        L2Token = new RACEMintableERC721(
            address(L2Bridge),
            1,
            address(L1Token),
            "L2Token",
    ...
    function test_supportsInterfaces_succeeds() external {
        // Checks if the contract supports the IRACEMintableERC721 interface.
        assertTrue(L2Token.supportsInterface(type(IRACEMintableERC721).interfaceId));
    ...
    function test_safeMint_notBridge_reverts() external {
        ...
        vm.expectRevert("RACEMintableERC721: only bridge can call this function");
