...
contract RACEPortal_Invariant_Harness is Portal_Initializer {
...
contract RACEPortal_CannotTimeTravel is RACEPortal_Invariant_Harness {
...
contract RACEPortal_CannotFinalizeTwice is RACEPortal_Invariant_Harness {
    function setUp() public override {
        super.setUp();
...
contract RACEPortal_CanAlwaysFinalizeAfterWindow is RACEPortal_Invariant_Harness {
    function setUp() public override {
        super.setUp();
