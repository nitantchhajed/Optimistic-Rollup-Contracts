...
contract Portal_Initializer is L2OutputOracle_Initializer {
    // Test target
    RACEPortal internal opImpl;
    RACEPortal internal op;
    ...
    function setUp() public virtual override {
        ...
        proxy.upgradeToAndCall(
            address(opImpl),
            abi.encodeWithSelector(RACEPortal.initialize.selector, false)
        );
        op = RACEPortal(payable(address(proxy)));
        vm.label(address(op), "RACEPortal");
    }
}
...
contract Bridge_Initializer is Messenger_Initializer {
    ...
    RACEMintableERC20Factory L2TokenFactory;
    RACEMintableERC20Factory L1TokenFactory;
    ERC20 L1Token;
    ERC20 BadL1Token;
    RACEMintableERC20 L2Token;
    LegacyMintableERC20 LegacyL2Token;
    ERC20 NativeL2Token;
    ERC20 BadL2Token;
    RACEMintableERC20 RemoteL1Token;
    ...
    function setUp() public virtual override {
        ...
        vm.label(Predeploys.RACE_MINTABLE_ERC20_FACTORY, "RACEMintableERC20Factory");
        ...
        RACEMintableERC20Factory factory = new RACEMintableERC20Factory(
            Predeploys.L2_STANDARD_BRIDGE
        );
        vm.etch(Predeploys.RACE_MINTABLE_ERC20_FACTORY, address(factory).code);
        L2TokenFactory = RACEMintableERC20Factory(Predeploys.RACE_MINTABLE_ERC20_FACTORY);
        ...
        L1TokenFactory = new RACEMintableERC20Factory(address(L1Bridge));

        RemoteL1Token = RACEMintableERC20(
