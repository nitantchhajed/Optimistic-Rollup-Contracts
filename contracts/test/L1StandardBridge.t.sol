...
contract PreBridgeETH is Bridge_Initializer {
    function _preBridgeETH(bool isLegacy) internal {
        ...
        uint256 version = 0; // Internal constant in the RACEPortal: DEPOSIT_VERSION
        ...
        vm.expectCall(
            ...
            500,
            abi.encodeWithSelector(
                RACEPortal.depositTransaction.selector,
                address(L2Messenger),
                500,
                baseGas,
                false,
        ...
        // RACEPortal emits a TransactionDeposited event on `depositTransaction` call
...
contract L1StandardBridge_DepositETH_Test is PreBridgeETH {
    ...
    // - calls RACEPortal.depositTransaction
    // - only EOA
    // - ETH ends up in the RACEPortal
