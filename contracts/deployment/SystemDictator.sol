...
import { RACEMintableERC20Factory } from "../universal/RACEMintableERC20Factory.sol";
...
contract SystemDictator is OwnableUpgradeable {
    ...
    struct ProxyAddressConfig {
        ...
        address RACEPortalProxy;
        address l1CrossDomainMessengerProxy;
        address l1StandardBridgeProxy;
        address RACEMintableERC20FactoryProxy;
    ...
    struct ImplementationAddressConfig {
        ...
        RACEPortal RACEPortalImpl;
        L1CrossDomainMessenger l1CrossDomainMessengerImpl;
        L1StandardBridge l1StandardBridgeImpl;
        RACEMintableERC20Factory RACEMintableERC20FactoryImpl;
    ...
    /**
     * @notice Dynamic configuration for the RACEPortal. Determines
     *         if the system should be paused when initialized.
     */
    bool public RACEPortalDynamicConfig;
    ...
    function step5() public onlyOwner step(5) {
        ...
        // Upgrade and initialize the RACEPortal.
        config.globalConfig.proxyAdmin.upgradeAndCall(
            payable(config.proxyAddressConfig.RACEPortalProxy),
            address(config.implementationAddressConfig.RACEPortalImpl),
            abi.encodeCall(RACEPortal.initialize, (RACEPortalDynamicConfig))
        );
        ...
        // Transfer ETH from the L1StandardBridge to the RACEPortal.
        config.globalConfig.proxyAdmin.upgradeAndCall(
        ...
        // Upgrade the RACEMintableERC20Factory (no initializer).
        config.globalConfig.proxyAdmin.upgrade(
            payable(config.proxyAddressConfig.RACEMintableERC20FactoryProxy),
            address(config.implementationAddressConfig.RACEMintableERC20FactoryImpl)
        );
