...
contract EchidnaFuzzRACEPortal {
    RACEPortal internal portal;
    ...
    function testDepositTransactionCompletes(
        ...
        require(!_isCreation || _to == address(0), "EchidnaFuzzRACEPortal: invalid test case.");
