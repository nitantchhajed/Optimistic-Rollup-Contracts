...
/**
 * @title  MintManager
 * @notice Set as `owner` of the RACE token and responsible for the token inflation schedule.
...
contract MintManager is Ownable {
    ...
    /**
     * @notice Only the token owner is allowed to mint a certain amount of RACE per year.
     *
