...
/**
 * @title SystemConfig
 * @notice The SystemConfig contract is used to manage configuration of an RACE network. All
...
contract SystemConfig is OwnableUpgradeable, Semver {
    ...
    /**
     * @notice The configuration for the deposit fee market. Used by the RACEPortal
