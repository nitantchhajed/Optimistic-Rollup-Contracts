 ...
 */
contract LegacyERC20ETH is RACEMintableERC20 {
    /**
     * @notice Initializes the contract as an RACE Mintable ERC20.
     */
    constructor()
        RACEMintableERC20(Predeploys.L2_STANDARD_BRIDGE, address(0), "Ether", "ETH")
    {}
